    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "submit_date",
                    models.DateTimeField(auto_now_add=True, verbose_name="Submit date"),
                ),
                (
                    "ip_address",
                    models.GenericIPAddressField(null=True, verbose_name="IP address", blank=True),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Mark the form as archived when the e-mail has been handled.",
                        db_index=True,
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=100,
                        verbose_name="Form",
                        choices=fluentcms_contactform.appsettings.FORM_STYLE_CHOICES,
                    ),
                ),
                (
                    "email_to",
                    models.EmailField(
                        help_text="The email address where submitted forms should be sent to.",
                        max_length=200,
